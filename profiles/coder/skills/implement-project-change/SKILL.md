...
Locate the assigned project under /projects. Read applicable AGENTS.md and project documentation. Inspect git status and the relevant code before changing files; identify user edits and the requested acceptance behavior.
...
Inspect the final diff for accidental edits and generated junk. Persist deliverables under /projects. Hand off project path, base revision, changed revision or explicit patch, acceptance criteria, commands and results, and remaining risks. Ask for review via the task's supported review workflow and name reviewer. Do not merge or publish without authorization.
